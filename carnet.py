...
def ClassAwareRegularizationNetwork(
    ...
    #     flops = tf.compat.v1.profiler.profile(sess.graph, run_meta=run_metadata, cmd='op', options=opt)
    #     opt = tf.compat.v1.profiler.ProfileOptionBuilder.trainable_variables_parameter()
    #     param_count = tf.compat.v1.profiler.profile(sess.graph, run_meta=run_metadata, cmd='op', options=opt)
